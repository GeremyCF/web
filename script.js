...
document.getElementById("btnSi").addEventListener("click", function () {
  Swal.fire({
    position: "top-center",
    title: "Sabia que dirias que si, siempre me haces querer ser un mejor hombre🥰",
    showConfirmButton: false,
    timer: 2000,
  });

  var parrafo = document.querySelector("#cuadroDialogo p");
  parrafo.textContent = "Vamos a escribir nuestra propia historia juntos...";
...
document.getElementById("btnNo").addEventListener("click", function () {
    Swal.fire({
        title: "Ta que eres graciosa para eso si :v",
        width: 600,
        padding: "3em",
        color: "#716add",
